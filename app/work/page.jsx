...
const projects = [
  ...
  },
  {
    ...
    title: "project 2",
    description:
      "Developed a cross-platform melanoma detection application using React Native, enabling deployment on both iOS and Android.",
    stack: [
      { name: "React Native" },
      { name: "Typescript" },
      { name: "iOS" },
    ...
    live: "https://www.youtube.com/watch?v=0vl7Ifr0uNI",
    github: "https://github.com/DeepEnd007/Master-Melanoma",
  },
  {
    num: "03",
    category: "frontend project",
    title: "project 3",
    description:
      "An online menu for customers to browse reviews, make reservations, and learn the story behind the meal.",
    stack: [
      { name: "Javascript" },
      { name: "CSS 3" },
      { name: "HTML 5" },
